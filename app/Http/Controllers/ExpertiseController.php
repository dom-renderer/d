...
class ExpertiseController extends Controller
{
    ...
    {
        if (ExpertiseUser::where('expertise_id', $id)->exists()) {
            return response()->json(['error' => 'You can\'t delete this expertise because there may be users who are pursuing it.']);
        } else {
