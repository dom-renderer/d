...
class NotificationTemplateController extends Controller
{
    ...
    public function create()
    {
        ...
        return view($this->view . 'create', compact('title', 'subTitle', 'notificationTypes', 'availableVariables', 'roles'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view($this->view . 'edit', compact('template', 'title', 'subTitle', 'notificationTypes', 'availableVariables', 'roles', 'selectedRoles'));
        } catch (\Exception $e) {
            return redirect()->route('notification-templates.index')->with('error', 'Notification template not found.');
        }
    }
