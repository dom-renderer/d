...
class UserController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        $currentDepartments = DepartmentUser::with('department')->where('user_id', $user->id)->get();

        $title = $this->title;
        $subTitle = 'User Details';
        return view($this->view . 'view', compact('title', 'subTitle', 'user', 'currentDepartments'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view($this->view . 'edit', compact('title', 'subTitle', 'user', 'roles', 'userRoleIds', 'currentDepartments'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            if (!empty($deptsToKeep)) {
                DepartmentUser::whereNotIn('id', $deptsToKeep)->where('user_id', $user->id)->delete();
            } else {
