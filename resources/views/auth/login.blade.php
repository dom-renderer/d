...
<style>
	...
	.iti__selected-country {
		background-image: url("http://127.0.0.1:8000/settings-media/arrow-1234.svg");
							...
							<div class="card-body">
								<div class="m-sm-3">
                                    <form method="POST" action="{{ route('login') }}" id="login-form">
										...
										<div class="mb-4 pt-2" style="text-align: center;">
											<!-- <h2 align="center"> {{ Helper::title() }} </h2> -->
											 <!-- <h2>
												<a href="#"></a>
											 </h2> -->
											 <img src="{{ url('settings-media/logo2.png') }}" alt="" />
										</div>
