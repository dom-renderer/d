            ...
            <div class="card-body">
                <form id="engineerForm" method="POST" action="{{ route('engineers.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-4">
                            <div>
                                ...
                                <input type="tel" class="form-control @error('phone_number') is-invalid @enderror" placeholder="Enter Your Phone Number" id="phone_number" name="phone_number" value="{{ old('phone_number') }}" required>
                    ...
                    <div class="mb-4 close-icon">
                        ...
                        <img src="{{ url('settings-media/close-rd-icn.svg') }}" alt="" />
                    </div>
                    <div class="mb-4">
                    ...
                    <a href="{{ route('engineers.index') }}" class="btn btn-secondary ms-3">Cancel</a>
                </form>
            </div>
        </div>
    </div>
