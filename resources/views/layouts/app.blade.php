...
<head>
    ...
    <link href="{{ asset('assets/css/theme-2.css') }}?time={{ time() }}" rel="stylesheet">
...
<body>
	...
	<div class="wrapper">
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-theme">
				<a class="sidebar-toggle d-flex me-2" id="sidebar-toggle-button">
					...
					<ul class="navbar-nav ms-auto">
						<li class="nav-item dropdown ms-lg-2">
							<a class="nav-link dropdown-toggle position-relative" href="#" id="userDropdown" data-bs-toggle="dropdown">
								...
								<img src="{{ url('settings-media/seting-icn.svg') }}" alt="" />
							</a>
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
								@can('settings.index')
									<a class="dropdown-item" style="padding-left:15px" href="{{ route('settings.index') }}">
				...
				<div class="container-fluid">
					...
					<div class="header">
						<h1 class="header-title">
							...
							<span class="float-end">
								<a href="{{ $rightButton['link'] }}" class="btn btn-primary">
									{{ $rightButton['title'] }}	
								</a>
							</span>
							@endif
	...
	<script src="{{ asset('assets/js/dms_common.js') }}"></script>
