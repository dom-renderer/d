            ...
            <div class="card-body">
                <form action="{{ route('notification-templates.update', encrypt($template->id)) }}" method="POST" id="notificationTemplateForm">
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-md-6">
                            <div class="mb-3">
                                <label for="type" class="form-label"> Roles <span class="text-danger">*</span></label>
                                <select name="roles[]" id="roles" class="form-select select2" multiple required>
                                    @foreach($roles as $role)
                                        <option value="{{ $role->id }}" {{ in_array( $role->name, $selectedRoles) ? 'selected' : '' }}>{{ $role->title }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            @foreach($availableVariables as $variable)
                                <div class="col-md-3 mb-2 user-btn">
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-primary ms-3">Update Template</button>
                    </div>
                </form>
            </div>
        </div>
