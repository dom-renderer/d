            ...
            <div class="card-body">
                <form id="userForm" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('profile') is-invalid @enderror" placeholder="Profile Image" id="profile" name="profile" accept="image/*">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2 @error('roles') is-invalid @enderror" id="roles" placeholder="Roles" name="roles[]" multiple required>
